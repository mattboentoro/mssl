...
export function TeamColorBar({
  ...
  return (
    <span
      aria-hidden
      className={`dark:ring-foreground/30 inline-flex shrink-0 flex-col overflow-hidden rounded-full ring-1 ring-black/10 ${dimension}`}
    >
...
export function KitSwatch({
  ...
  return (
    <span
      className="dark:ring-foreground/30 inline-block h-3 w-1.5 shrink-0 rounded-full ring-1 ring-black/20"
